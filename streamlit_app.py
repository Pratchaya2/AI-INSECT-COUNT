...
# ─────────────────────────────────────────
LOCATION_DATA = {
    "SB": {"บรรจุ": ["ห้องแต่งตัว", "ห้องบรรจุ 1", "ห้องบรรจุ 2", "ห้องบรรจุ 3", "ห้องบรรจุ Auto","ห้องบรรจุ 4", "ห้อง Mix SP", "ห้องบรรจุ SP", "ห้องเก็บภาชนะ ชั้น 1", "ห้องเก็บภาชนะ ชั้น 2", "ห้อง Pack SP"]},
    "MDC": {
        ...
        "อาคารผลิตน้ำตาลปี้บ": [f"เครื่องที่ {i}" for i in range(1,16)],
    },
    "MPK": {
        "บรรจุ": ["1.ห้องเก็บกระสอบ 50 กก.", "2.ห้องเตรียมกระสอบ 50 กก.", "3.ห้องบรรจุ 50 กก.", "4.ห้องเตรียมกระสอบ silo", "5.ห้องบรรจุ Silo", "6.ทางเดินห้องบรรจุ 1 กก. Silo", "7.ห้องบรรจุ 1 กก. No.1", "8.ห้องบรรจุ 1 กก. No.2", "9.ห้องเก็บกระสอบบรูไน", "10.ห้องบรรจุบรูไน", "11.ห้องบรรจุ Demerara B2", "12.ห้องเตรียมกระสอบ Demerara B2", "19. ห้องเก็บกระสอบรีแพค K5", "20. ห้องบรรจุรีแพค K5", "21.ห้องบรรจุรีแพค Demerara K5", "22.ห้องเก็บกระสอบรีแพค Demerara K5"],
        "Conditioning Silo": ["13.ห้องตะแกรงคัดเม็ด  Nestle", "14.ห้องตะแกรงคัดเม็ด  Rotex"],
        "เคี่ยวปั่นรีไฟน์": ["15.ห้องใต้หม้อปั่น ", "16.ห้องสายพานห้องล่าง ", "17.ห้องสายพานบน No.1", "18.ห้องสายพานบน No.2"],
    },
    "MPV": {
